...
**🏆 [Canvas LMS Automation](https://github.com/chartorresgg/canvas-automation)** — Production system, in daily use  
...
**Stack:** *Spring Boot · Eureka · MongoDB · MySQL · Docker Compose*  
